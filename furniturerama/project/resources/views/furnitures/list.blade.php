		...
		<div class="col-9 mt-1 pb-5">
			...
			<div class="row">
				<div class="col mb-3 mt-4">
					<h1 class="title text-muted" style="font-size:1.4em;">{{ $title ?? 'Shop All' }}</h1>
				</div>
			</div>
			<div class="row">
					...
					<div class="col-md-4 col-sm-6 mb-4">
						<div class="product-grid bg-white pb-3 shadow">
							...
							<div class="product-image">
								...
								<a href="/furnitures/{{ $furniture->id }}/detail"><img src="{{ $furniture->image }}" alt="{{ $furniture->name }}" class="img-fluid" style="max-width: 100%; height:auto"></a>
